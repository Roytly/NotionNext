...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Roytly', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的学生🏫', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.roytly.us.kg', // 网站地址
